'''
@Author: your name
@Date: 2020-04-03 20:04:28
@LastEditTime: 2020-04-03 20:45:51
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \刷题人生\leetcode\8.字符串转换整数-atoi.py
'''
#
...
class Solution:
    ...
    # *是解包
    # 使用正则表达式 ^：匹配字符串开头，[\+\-]：代表一个+字符或-字符，?：
    # 前面一个字符可有可无，\d：一个数字，+：前面一个字符的一个或多个，\D：一个非数字字符
